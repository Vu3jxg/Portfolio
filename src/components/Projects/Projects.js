        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              demoLink="https://drive.google.com/file/d/1KD7eniVc9KzExi9Rp_cfABM2ErV25-4F/view?usp=sharing"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              demoLink="https://ieeexplore.ieee.org/document/10539501"
            />
          </Col>
...
extended to other domains as well."
              demoLink="https://www.techrxiv.org/users/778781/articles/913753-architecting-digital-twin-for-smart-city-systems-a-case-study"              
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={paper3}
              isBlog={false}
              title="Exploratory Study of oneM2M-based
Interoperability Architectures for IoT: A Smart City
Perspective
"
...
outperforming its counterparts."
              demoLink="https://smartcitylivinglab.iiit.ac.in/api-media/pdf_files/Exploratory_Study_of_oneM2M-based_Interoperability.pdf"
            />
          </Col>
